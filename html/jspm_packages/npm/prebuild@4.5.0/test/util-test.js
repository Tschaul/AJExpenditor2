...
(function(process) {
  ...
  test('urlTemplate() returns different templates based on pkg and rc', function(t) {
    ...
    var o2 = {pkg: {binary: {host: 'http://foo.com'}}};
  ...
  test('nodeGypPath(): accepts any arguments', function(t) {
    ...
    t.equal(nodeGypPath('.node-gyp', '0.10.40', 'include/node'), home() + '/.node-gyp/0.10.40/include/node');
    t.equal(nodeGypPath('.node-gyp', '4.1.0', 'include/node', 'node.h'), home() + '/.node-gyp/4.1.0/include/node/node.h');
    t.equal(nodeGypPath('.node-gyp', '/iojs-1.0.4/', '/include/node/', '/node.h'), home() + '/.node-gyp/iojs-1.0.4/include/node/node.h', 'trailing slashes should not matter');
    t.end();
  });
})(require('process'));
