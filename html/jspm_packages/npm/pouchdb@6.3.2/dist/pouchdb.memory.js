...
(function(Buffer, process) {
  (function e(t, n, r) {
    ...
    6: [function(_dereq_, module, exports) {
      ...
      }).call(this, {"isBuffer": _dereq_(27)});
    }, {"27": 27}],
    7: [function(_dereq_, module, exports) {
      var util = _dereq_(106),
    ...
    8: [function(_dereq_, module, exports) {
      ...
      }).call(this, {"isBuffer": _dereq_(27)}, _dereq_(62));
    }, {
      "106": 106,
      "12": 12,
      "27": 27,
    ...
    22: [function(_dereq_, module, exports) {
      'use strict';
      module.exports = _dereq_(21) && typeof Symbol.toStringTag === 'symbol';
    }, {"21": 21}],
    ...
    28: [function(_dereq_, module, exports) {
      ...
      var toStringTag = _dereq_(102);
      var hasToStringTag = _dereq_(22);
      var isPrimitive = _dereq_(30);
    ...
    35: [function(_dereq_, module, exports) {
      ...
      var Readable = _dereq_(70).Readable;
      var extend = _dereq_(36);
      var EncodingError = _dereq_(34).EncodingError;
    ...
    37: [function(_dereq_, module, exports) {
      var util = _dereq_(39),
          WriteError = _dereq_(34).WriteError,
    ...
    38: [function(_dereq_, module, exports) {
      (function(process) {
        var EventEmitter = _dereq_(19).EventEmitter,
            inherits = _dereq_(106).inherits,
            deprecate = _dereq_(106).deprecate,
            extend = _dereq_(42),
            prr = _dereq_(63),
            DeferredLevelDOWN = _dereq_(8),
            IteratorStream = _dereq_(35),
            errors = _dereq_(34),
        ...
        module.exports.errors = _dereq_(34);
    ...
    47: [function(_dereq_, module, exports) {
      (function(Buffer) {
        var inherits = _dereq_(25),
            AbstractLevelDOWN = _dereq_(51).AbstractLevelDOWN,
            AbstractIterator = _dereq_(51).AbstractIterator,
            ltgt = _dereq_(59),
            createRBT = _dereq_(20),
            globalStore = {};
        var setImmediate = _dereq_(46);
        function gt(value) {
    ...
    53: [function(_dereq_, module, exports) {
      'use strict';
      var types = [_dereq_(56), _dereq_(55), _dereq_(54), _dereq_(57), _dereq_(58)];
      var draining;
      var currentQueue;
      var queueIndex = -1;
      var queue = [];
    ...
    73: [function(_dereq_, module, exports) {
      ...
      var inherits = _dereq_(25);
      inherits(Stream, EE);
      Stream.Readable = _dereq_(84);
      Stream.Writable = _dereq_(86);
      Stream.Duplex = _dereq_(74);
      Stream.Transform = _dereq_(85);
      Stream.PassThrough = _dereq_(83);
    ...
    77: [function(_dereq_, module, exports) {
      (function(process, global) {
        ...
        var BufferList = _dereq_(80);
        var destroyImpl = _dereq_(81);
        var StringDecoder;
        util.inherits(Readable, Stream);
        ...
        function ReadableState(options, stream) {
          ...
          if (options.encoding) {
            if (!StringDecoder)
              StringDecoder = _dereq_(87).StringDecoder;
            this.decoder = new StringDecoder(options.encoding);
            this.encoding = options.encoding;
          }
        }
      ...
      }).call(this, _dereq_(62), typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
    }, {
      "19": 19,
      "25": 25,
      "3": 3,
    ...
    79: [function(_dereq_, module, exports) {
      (function(process, global) {
        ...
        var util = _dereq_(6);
        util.inherits = _dereq_(25);
        var internalUtil = {deprecate: _dereq_(103)};
        var Stream = _dereq_(82);
        var Buffer = _dereq_(71).Buffer;
        var OurUint8Array = global.Uint8Array || function() {};
        function _uint8ArrayToBuffer(chunk) {
    ...
    102: [function(_dereq_, module, exports) {
      'use strict';
      var isNull = _dereq_(44);
      var isUndefined = _dereq_(110);
    ...
    112: [function(_dereq_, module, exports) {
      (function(global) {
        ...
        var nextTick = _interopDefault(_dereq_(24));
        var v4 = _interopDefault(_dereq_(109));
        var levelup = _interopDefault(_dereq_(38));
        var ltgt = _interopDefault(_dereq_(45));
        var Codec = _interopDefault(_dereq_(32));
        var ReadableStreamCore = _interopDefault(_dereq_(70));
        var through2 = _dereq_(101);
        var Deque = _interopDefault(_dereq_(15));
        var bufferFrom = _interopDefault(_dereq_(4));
        var Md5 = _interopDefault(_dereq_(72));
        var vuvuzela = _interopDefault(_dereq_(111));
        var memdown = _interopDefault(_dereq_(47));
        ...
        function MemDownPouch(opts, callback) {
          var _opts = $inject_Object_assign({db: memdown}, opts);
        ...
        if (typeof PouchDB === 'undefined') {
          guardedConsole('error', 'memory adapter plugin error: ' + 'Cannot find global "PouchDB" object! ' + 'Did you remember to include pouchdb.js?');
        } else {
