...
(function(process) {
  ...
  var argv = require('../../minimist/index')(process.argv.slice(2));
  var execshell = require('../../exec-sh/lib/exec-sh');
  if (argv._.length === 0) {
    var msg = 'Usage: sane <command> [...directory] [--glob=<filePattern>] ' + '[--poll] [--watchman] [--dot] [--wait=<seconds>]';
    console.error(msg);
    process.exit();
  }
  var opts = {};
