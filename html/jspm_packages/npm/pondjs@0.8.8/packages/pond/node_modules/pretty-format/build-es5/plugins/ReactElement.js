...
function printProps(props, print, indent, colors, opts) {
  return (0, _keys2.default)(props).sort().map(function(name) {
    if (name === 'children') {
      return '';
    }
    var prop = props[name];
...
var print = function print(element, _print, indent, opts, colors) {
  ...
  var hasProps = !!(0, _keys2.default)(element.props).filter(function(propName) {
