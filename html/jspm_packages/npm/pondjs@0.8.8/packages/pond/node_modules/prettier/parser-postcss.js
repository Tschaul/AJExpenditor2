...
(function(Buffer, process) {
  module.exports = (function(modules) {
      ...
      Container.prototype.normalize = function normalize(nodes, sample) {
        ...
        if (typeof nodes === 'string') {
          ...
          for (var _iterator10 = nodes,
            ...
            var _i10 = _ref10;
            if (_i10.parent)
              _i10.parent.removeChild(_i10, 'ignore');
          }
        } else if (nodes.type) {
          nodes = [nodes];
        } else if (nodes.prop) {
    ...
    var Import = function(_PostCssRule) {
      ...
      _createClass(Import, [{
        ...
        value: function toString(stringifier) {
          if (!stringifier) {
            stringifier = {stringify: _lessStringify2.default};
          }
    ...
    function isMixinToken(token) {
      ...
      return (firstSymbolCode === _globals.dot || firstSymbolCode === _globals.hash) && _globals.hashColorPattern.test(symbol) === false && unpaddedFractionalNumbersPattern.test(symbol) === false;
    }
    module.exports = exports['default'];
  }), (function(module, exports, __webpack_require__) {
    "use strict";
    ...
    }.call(exports, __webpack_require__(86)(module)));
  }), (function(module, exports, __webpack_require__) {
    "use strict";
    (function(process) {
          ...
          default:
            if (code === slash && css.charCodeAt(pos + 1) === asterisk) {
              ...
              if (regex === wordEndNum || code === period) {
                ...
                if ((code1 === smallE || code1 === bigE) && (code2 === minus || code2 === plus) && (code3 >= digit0 && code3 <= digit9)) {
    ...
    }.call(exports, __webpack_require__(85), __webpack_require__(7)));
  }), (function(module, exports, __webpack_require__) {
    "use strict";
    ...
    function parseNestedCSS(node) {
      if (node && typeof node === "object") {
        ...
        if (typeof node.selector === "string") {
          const selector = node.raws.selector ? node.raws.selector.raw : node.selector;
          try {
        ...
        if (node.type && typeof node.value === "string") {
          try {
            ...
            throw createError("(postcss-values-parser) " + e.toString(), node.source);
          }
        }
