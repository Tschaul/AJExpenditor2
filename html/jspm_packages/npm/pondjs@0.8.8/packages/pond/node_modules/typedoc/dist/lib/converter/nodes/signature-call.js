...
var SignatureConverter = (function(_super) {
  ...
  function SignatureConverter() {
    ...
    _this.supports = [ts.SyntaxKind.CallSignature, ts.SyntaxKind.FunctionType, ts.SyntaxKind.FunctionExpression, ts.SyntaxKind.ArrowFunction];
    return _this;
  }
...
SignatureConverter = __decorate([components_1.Component({name: 'node:signature-call'})], SignatureConverter);
