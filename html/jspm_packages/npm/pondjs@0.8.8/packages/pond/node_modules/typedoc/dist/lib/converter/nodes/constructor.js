...
var ConstructorConverter = (function(_super) {
  ...
  function ConstructorConverter() {
    ...
    _this.supports = [ts.SyntaxKind.Constructor, ts.SyntaxKind.ConstructSignature];
    return _this;
  }
...
ConstructorConverter = __decorate([components_1.Component({name: 'node:constructor'})], ConstructorConverter);
