...
var HighlightJS = require('../../../../../highlight.js/lib/index');
...
var MarkedPlugin = (function(_super) {
  ...
  MarkedPlugin.prototype.initialize = function() {
    ...
    Handlebars.registerHelper('relativeURL', function(url) {
      return url ? _this.getRelativeUrl(url) : url;
    });
    Marked.setOptions({highlight: function(text, lang) {
...
MarkedPlugin = __decorate([components_1.Component({name: 'marked'})], MarkedPlugin);
