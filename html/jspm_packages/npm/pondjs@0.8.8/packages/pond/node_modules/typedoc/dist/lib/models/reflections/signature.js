...
var SignatureReflection = (function(_super) {
  ...
  SignatureReflection.prototype.traverse = function(callback) {
    ...
    if (this.typeParameters) {
      this.typeParameters.forEach(function(parameter) {
        return callback(parameter, abstract_1.TraverseProperty.TypeParameter);
      });
    }
    if (this.parameters) {
      this.parameters.forEach(function(parameter) {
        return callback(parameter, abstract_1.TraverseProperty.Parameters);
      });
    }
  ...
  SignatureReflection.prototype.toString = function() {
    ...
    if (this.typeParameters) {
      var parameters_1 = [];
      this.typeParameters.forEach(function(parameter) {
        return parameters_1.push(parameter.name);
      });
