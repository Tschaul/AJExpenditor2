...
var PackagePlugin = (function(_super) {
  ...
  PackagePlugin.prototype.initialize = function() {
    this.listenTo(this.owner, (_a = {}, _a[converter_1.Converter.EVENT_BEGIN] = this.onBegin, _a[converter_1.Converter.EVENT_FILE_BEGIN] = this.onBeginDocument, _a[converter_1.Converter.EVENT_RESOLVE_BEGIN] = this.onBeginResolve, _a));
    var _a;
  };
  ...
  PackagePlugin.prototype.onBeginDocument = function(context, reflection, node) {
    ...
    var dirName,
        parentDir = Path.resolve(Path.dirname(fileName));
    do {
      dirName = parentDir;
...
PackagePlugin = __decorate([components_1.Component({name: 'package'})], PackagePlugin);
