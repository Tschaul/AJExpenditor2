...
var TSConfigReader = TSConfigReader_1 = (function(_super) {
  ...
  TSConfigReader.prototype.load = function(event, fileName) {
    ...
    var _a = ts.parseJsonConfigFileContent(config, ts.sys, Path.resolve(Path.dirname(fileName)), {}, Path.resolve(fileName)),
        fileNames = _a.fileNames,
        options = _a.options,
        typedocOptions = _a.raw.typedocOptions;
    event.inputFiles = fileNames;
    var ignored = typescript_1.TypeScriptSource.IGNORED;
    for (var _i = 0,
        ignored_1 = ignored; _i < ignored_1.length; _i++) {
...
TSConfigReader = TSConfigReader_1 = __decorate([component_1.Component({name: 'options:tsconfig'})], TSConfigReader);
