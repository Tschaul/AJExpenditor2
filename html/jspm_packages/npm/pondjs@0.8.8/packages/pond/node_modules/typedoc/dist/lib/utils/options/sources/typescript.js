...
var TypeScriptSource = TypeScriptSource_1 = (function(_super) {
  ...
  TypeScriptSource.prototype.initialize = function() {
    ...
    this.declarations = [];
    for (var _i = 0,
        _a = _ts.optionDeclarations; _i < _a.length; _i++) {
...
TypeScriptSource.IGNORED = ['out', 'version', 'help', 'watch', 'declaration', 'declarationDir', 'mapRoot', 'sourceMap', 'inlineSources', 'removeComments'];
TypeScriptSource = TypeScriptSource_1 = __decorate([component_1.Component({name: 'options:typescript'})], TypeScriptSource);
