...
var ComponentSource = (function(_super) {
  ...
  ComponentSource.prototype.initialize = function() {
    ...
    this.listenTo(this.application, (_a = {}, _a[component_1.ComponentEvent.ADDED] = this.onComponentAdded, _a[component_1.ComponentEvent.REMOVED] = this.onComponentRemoved, _a));
    var _a;
  };
  ComponentSource.prototype.addComponent = function(component) {
    ...
    if (component instanceof component_1.ChildableComponent) {
      for (var _i = 0,
          _a = component.getComponents(); _i < _a.length; _i++) {
        var child = _a[_i];
  ...
  ComponentSource.prototype.removeComponent = function(component) {
    ...
    if (index !== -1) {
      ...
      for (var _i = 0,
          _a = component.getOptionDeclarations(); _i < _a.length; _i++) {
    ...
    if (component instanceof component_1.ChildableComponent) {
      for (var _b = 0,
          _c = component.getComponents(); _b < _c.length; _b++) {
        var child = _c[_b];
...
ComponentSource = __decorate([component_1.Component({name: 'options:component'})], ComponentSource);
