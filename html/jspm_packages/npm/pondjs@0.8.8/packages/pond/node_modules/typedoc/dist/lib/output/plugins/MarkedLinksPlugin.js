...
var MarkedLinksPlugin = MarkedLinksPlugin_1 = (function(_super) {
  ...
  MarkedLinksPlugin.prototype.initialize = function() {
    ...
    this.listenTo(this.owner, (_a = {}, _a[events_1.MarkdownEvent.PARSE] = this.onParseMarkdown, _a[events_1.RendererEvent.END] = this.onEndRenderer, _a), null, 100);
    var _a;
  };
  ...
  MarkedLinksPlugin.prototype.onEndRenderer = function(event) {
    if (this.listInvalidSymbolLinks && this.warnings.length > 0) {
      ...
      this.application.logger.warn('[MarkedLinksPlugin]: Found invalid symbol reference(s) in JSDocs, ' + 'they will not render as links in the generated documentation.');
      for (var _i = 0,
          _a = this.warnings; _i < _a.length; _i++) {
        var warning = _a[_i];
...
MarkedLinksPlugin = MarkedLinksPlugin_1 = __decorate([components_1.Component({name: 'marked-links'})], MarkedLinksPlugin);
