...
var ModuleConverter = (function(_super) {
  ...
  function ModuleConverter() {
    ...
    _this.supports = [ts.SyntaxKind.ModuleDeclaration];
    return _this;
  }
  ModuleConverter.prototype.convert = function(context, node) {
    ...
    context.withScope(reflection, function() {
      if (parent instanceof index_1.ProjectReflection && !context.isDeclaration && (!module || module.valueOf() === ts.ModuleKind.None.valueOf())) {
...
ModuleConverter = __decorate([components_1.Component({name: 'node:module'})], ModuleConverter);
