...
var BlockConverter = (function(_super) {
  ...
  function BlockConverter() {
    ...
    _this.supports = [ts.SyntaxKind.Block, ts.SyntaxKind.ModuleBlock, ts.SyntaxKind.SourceFile];
    return _this;
  }
...
BlockConverter = __decorate([components_1.Component({name: 'node:block'})], BlockConverter);
