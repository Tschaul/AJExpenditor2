...
var IndexSignatureConverter = (function(_super) {
  ...
  function IndexSignatureConverter() {
    ...
    _this.supports = [ts.SyntaxKind.IndexSignature];
    return _this;
  }
...
IndexSignatureConverter = __decorate([components_1.Component({name: 'node:signature-index'})], IndexSignatureConverter);
