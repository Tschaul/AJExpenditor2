...
var GroupPlugin = GroupPlugin_1 = (function(_super) {
  ...
  GroupPlugin.prototype.initialize = function() {
    this.listenTo(this.owner, (_a = {}, _a[converter_1.Converter.EVENT_RESOLVE] = this.onResolve, _a[converter_1.Converter.EVENT_RESOLVE_END] = this.onEndResolve, _a));
    var _a;
  };
...
GroupPlugin = GroupPlugin_1 = __decorate([components_1.Component({name: 'group'})], GroupPlugin);
