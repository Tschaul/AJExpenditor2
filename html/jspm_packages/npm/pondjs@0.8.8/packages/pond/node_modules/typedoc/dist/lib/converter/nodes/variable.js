...
var VariableConverter = (function(_super) {
  ...
  function VariableConverter() {
    ...
    _this.supports = [ts.SyntaxKind.PropertySignature, ts.SyntaxKind.PropertyDeclaration, ts.SyntaxKind.PropertyAssignment, ts.SyntaxKind.ShorthandPropertyAssignment, ts.SyntaxKind.VariableDeclaration, ts.SyntaxKind.BindingElement];
    return _this;
  }
...
VariableConverter = __decorate([components_1.Component({name: 'node:variable'})], VariableConverter);
