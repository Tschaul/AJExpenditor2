...
var Options = (function(_super) {
  ...
  Options.prototype.read = function(data, mode) {
    ...
    if (mode === OptionsReadMode.Fetch) {
      ...
      for (var _i = 0,
          _a = event.errors; _i < _a.length; _i++) {
        var error = _a[_i];
        logger.error(error);
      }
    }
  ...
  Options.prototype.addDeclaration = function(declaration) {
    ...
    for (var _i = 0,
        _a = decl.getNames(); _i < _a.length; _i++) {
      var name_2 = _a[_i];
...
Options = __decorate([component_1.Component({
  name: 'options',
  internal: true,
  childClass: OptionsComponent
})], Options);
