...
var CommentPlugin = CommentPlugin_1 = (function(_super) {
  ...
  CommentPlugin.removeReflection = function(project, reflection) {
    reflection.traverse(function(child) {
      return CommentPlugin_1.removeReflection(project, child);
    });
...
CommentPlugin = CommentPlugin_1 = __decorate([components_1.Component({name: 'comment'})], CommentPlugin);
