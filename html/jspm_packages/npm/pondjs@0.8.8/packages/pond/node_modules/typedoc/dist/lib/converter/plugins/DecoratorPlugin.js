...
var DecoratorPlugin = (function(_super) {
  ...
  DecoratorPlugin.prototype.initialize = function() {
    this.listenTo(this.owner, (_a = {}, _a[converter_1.Converter.EVENT_BEGIN] = this.onBegin, _a[converter_1.Converter.EVENT_CREATE_DECLARATION] = this.onDeclaration, _a[converter_1.Converter.EVENT_CREATE_PARAMETER] = this.onDeclaration, _a[converter_1.Converter.EVENT_RESOLVE] = this.onBeginResolve, _a));
    var _a;
  };
  ...
  DecoratorPlugin.prototype.onDeclaration = function(context, reflection, node) {
    ...
    node.decorators.forEach(function(decorator) {
      ...
      var info = {name: _ts.getTextOfNode(identifier)};
...
DecoratorPlugin = __decorate([components_1.Component({name: 'decorator'})], DecoratorPlugin);
