...
var NavigationPlugin = (function(_super) {
  ...
  NavigationPlugin.prototype.initialize = function() {
    this.listenTo(this.owner, (_a = {}, _a[events_1.RendererEvent.BEGIN] = this.onBeginRenderer, _a[events_1.PageEvent.BEGIN] = this.onBeginPage, _a));
    var _a;
  };
...
NavigationPlugin = __decorate([components_1.Component({name: 'navigation'})], NavigationPlugin);
