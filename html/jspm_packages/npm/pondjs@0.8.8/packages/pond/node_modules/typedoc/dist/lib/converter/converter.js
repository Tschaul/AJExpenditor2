...
var Converter = Converter_1 = (function(_super) {
  ...
  Converter.prototype.addNodeConverter = function(converter) {
    for (var _i = 0,
        _a = converter.supports; _i < _a.length; _i++) {
      var supports = _a[_i];
  ...
  Converter.prototype.convertType = function(context, node, type) {
    if (node) {
      ...
      for (var _i = 0,
          _a = this.typeNodeConverters; _i < _a.length; _i++) {
        var converter = _a[_i];
    ...
    if (type) {
      for (var _b = 0,
          _c = this.typeTypeConverters; _b < _c.length; _b++) {
        var converter = _c[_b];
...
Converter = Converter_1 = __decorate([component_1.Component({
  name: 'converter',
  internal: true,
