...
var DynamicModulePlugin = (function(_super) {
  ...
  DynamicModulePlugin.prototype.initialize = function() {
    this.listenTo(this.owner, (_a = {}, _a[converter_1.Converter.EVENT_BEGIN] = this.onBegin, _a[converter_1.Converter.EVENT_CREATE_DECLARATION] = this.onDeclaration, _a[converter_1.Converter.EVENT_RESOLVE_BEGIN] = this.onBeginResolve, _a));
    var _a;
  };
...
DynamicModulePlugin = __decorate([components_1.Component({name: 'dynamic-module'})], DynamicModulePlugin);
