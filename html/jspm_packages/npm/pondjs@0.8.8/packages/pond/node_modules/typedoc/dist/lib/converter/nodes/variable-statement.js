...
var VariableStatementConverter = (function(_super) {
  ...
  function VariableStatementConverter() {
    ...
    _this.supports = [ts.SyntaxKind.VariableStatement];
    return _this;
  }
...
VariableStatementConverter = __decorate([components_1.Component({name: 'node:variable-statement'})], VariableStatementConverter);
