...
var AccessorConverter = (function(_super) {
  ...
  function AccessorConverter() {
    ...
    _this.supports = [ts.SyntaxKind.GetAccessor, ts.SyntaxKind.SetAccessor];
    return _this;
  }
...
AccessorConverter = __decorate([components_1.Component({name: 'node:accessor'})], AccessorConverter);
