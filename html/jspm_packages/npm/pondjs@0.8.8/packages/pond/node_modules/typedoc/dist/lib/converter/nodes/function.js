...
var FunctionConverter = (function(_super) {
  ...
  function FunctionConverter() {
    ...
    _this.supports = [ts.SyntaxKind.MethodSignature, ts.SyntaxKind.MethodDeclaration, ts.SyntaxKind.FunctionDeclaration];
    return _this;
  }
...
FunctionConverter = __decorate([components_1.Component({name: 'node:function'})], FunctionConverter);
