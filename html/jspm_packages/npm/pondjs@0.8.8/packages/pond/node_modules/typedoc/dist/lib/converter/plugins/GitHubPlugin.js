...
var Repository = (function() {
  ...
  Repository.prototype.getGitHubURL = function(fileName) {
    ...
    return ['https://github.com', this.gitHubUser, this.gitHubProject, 'blob', this.branch, fileName.substr(this.path.length + 1)].join('/');
  };
...
var GitHubPlugin = (function(_super) {
  ...
  GitHubPlugin.prototype.getRepository = function(fileName) {
    ...
    for (var i = 0,
        c = this.ignoredPaths.length; i < c; i++) {
...
GitHubPlugin = __decorate([components_1.Component({name: 'git-hub'})], GitHubPlugin);
