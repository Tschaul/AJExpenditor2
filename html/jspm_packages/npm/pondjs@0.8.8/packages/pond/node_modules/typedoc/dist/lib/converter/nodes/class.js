...
var ClassConverter = (function(_super) {
  ...
  function ClassConverter() {
    ...
    _this.supports = [ts.SyntaxKind.ClassExpression, ts.SyntaxKind.ClassDeclaration];
    return _this;
  }
...
ClassConverter = __decorate([components_1.Component({name: 'node:class'})], ClassConverter);
