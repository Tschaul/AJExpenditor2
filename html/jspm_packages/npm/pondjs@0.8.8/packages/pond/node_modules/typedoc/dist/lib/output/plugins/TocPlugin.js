...
var TocPlugin = TocPlugin_1 = (function(_super) {
  ...
  TocPlugin.prototype.initialize = function() {
    this.listenTo(this.owner, (_a = {}, _a[events_1.PageEvent.BEGIN] = this.onRendererBeginPage, _a));
    var _a;
  };
...
TocPlugin = TocPlugin_1 = __decorate([components_1.Component({name: 'toc'})], TocPlugin);
