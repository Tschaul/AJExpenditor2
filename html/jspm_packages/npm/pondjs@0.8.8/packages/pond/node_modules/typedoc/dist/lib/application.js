...
var FS = require('fs');
var typescript = require('../../node_modules/typescript/lib/typescript');
...
var Application = Application_1 = (function(_super) {
  ...
  Application.prototype.toString = function() {
    return ['', 'TypeDoc ' + Application_1.VERSION, 'Using TypeScript ' + this.getTypeScriptVersion() + ' from ' + this.getTypeScriptPath(), ''].join(typescript.sys.newLine);
  };
  return Application;
...
Application = Application_1 = __decorate([component_1.Component({
  name: 'application',
  internal: true
})], Application);
