...
var AssetsPlugin = (function(_super) {
  ...
  AssetsPlugin.prototype.initialize = function() {
    this.listenTo(this.owner, (_a = {}, _a[events_1.RendererEvent.BEGIN] = this.onRendererBegin, _a));
    var _a;
  };
...
AssetsPlugin = __decorate([components_1.Component({name: 'assets'})], AssetsPlugin);
