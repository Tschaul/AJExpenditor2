...
var TypePlugin = (function(_super) {
  ...
  TypePlugin.prototype.initialize = function() {
    this.listenTo(this.owner, (_a = {}, _a[converter_1.Converter.EVENT_RESOLVE] = this.onResolve, _a[converter_1.Converter.EVENT_RESOLVE_END] = this.onResolveEnd, _a));
    var _a;
  };
  TypePlugin.prototype.onResolve = function(context, reflection) {
    ...
    function resolveType(reflection, type) {
      if (type instanceof index_2.ReferenceType) {
        ...
        var tupleType = type;
        for (var index = 0,
            count = tupleType.elements.length; index < count; index++) {
        ...
        for (var index = 0,
            count = unionOrIntersectionType.types.length; index < count; index++) {
...
TypePlugin = __decorate([components_1.Component({name: 'type'})], TypePlugin);
