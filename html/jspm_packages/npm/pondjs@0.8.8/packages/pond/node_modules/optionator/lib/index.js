...
(function(process) {
  (function() {
    var VERSION,
        ...
        slice$ = [].slice;
    VERSION = '0.8.2';
    ref$ = require('../../prelude-ls/lib/index'), id = ref$.id, map = ref$.map, compact = ref$.compact, any = ref$.any, groupBy = ref$.groupBy, partition = ref$.partition, chars = ref$.chars, isItNaN = ref$.isItNaN, keys = ref$.keys, Obj = ref$.Obj, camelize = ref$.camelize;
    deepIs = require('../../deep-is/index');
    ...
    ref$ = require('../../type-check/lib/index'), parsedTypeCheck = ref$.parsedTypeCheck, parseType = ref$.parseType;
    parseLevn = require('../../levn/lib/index').parsedTypeParse;
