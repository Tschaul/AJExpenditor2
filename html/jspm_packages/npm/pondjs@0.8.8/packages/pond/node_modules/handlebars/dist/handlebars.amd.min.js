...
define("handlebars/utils", ["exports"], function(a) {
  ...
  function c(a, b) {
    ...
    for (var h = Error.prototype.constructor.call(this, a),
        i = 0; i < d.length; i++)
      this[d[i]] = h[d[i]];
  ...
  b.exports = function(a) {
    a.registerHelper("blockHelperMissing", function(b, d) {
      ...
      if (b === !1 || null == b)
        return e(this);
      if (c.isArray(b))
        return b.length > 0 ? (d.ids && (d.ids = [d.name]), a.helpers.each(b, d)) : e(this);
      if (d.data && d.ids) {
  ...
  b.exports = function(a) {
    a.registerHelper("each", function(a, b) {
      ...
      var e = b.fn,
          ...
          j = void 0,
          k = void 0;
      if (b.data && b.ids && (k = c.appendContextPath(b.data.contextPath, b.ids[0]) + "."), c.isFunction(a) && (a = a.call(this)), b.data && (j = c.createFrame(b.data)), a && "object" == typeof a)
        if (c.isArray(a))
          ...
          var m = void 0;
          for (var n in a)
            a.hasOwnProperty(n) && (void 0 !== m && d(m, h - 1), m = n, h++);
          void 0 !== m && d(m, h - 1, !0);
        }
  ...
  h.prototype = {
    ...
    registerPartial: function(a, c) {
      if (b.toString.call(a) === n)
        b.extend(this.partials, a);
      else {
        if ("undefined" == typeof c)
          throw new i["default"]('Attempting to register a partial called "' + a + '" as undefined');
        this.partials[a] = c;
      }
    },
  ...
  function g(a, c) {
    ...
    if (!a || !a.main)
      throw new n["default"]("Unknown template object: " + typeof a);
    a.main.decorator = a.main_d, c.VM.checkRevision(a.compiler);
    var f = {
      strict: function(a, b) {
        if (!(b in a))
          throw new n["default"]('"' + b + '" not defined in ' + a);
        return a[b];
      },
      lookup: function(a, b) {
        for (var c = a.length,
  ...
  function j(a, c, e) {
    ...
    }(), void 0 === a && g && (a = g), void 0 === a)
      throw new n["default"]("The partial " + e.name + " could not be found");
          ...
          var a = {
            ...
            next: function() {
              ...
              for (var f = this._currentRules(),
                  g = 0; g < f.length && (c = this._input.match(this.rules[f[g]]), !c || b && !(c[0].length > b[0].length) || (b = c, d = g, this.options.flex)); g++)
                ;
    ...
    acceptKey: function(a, b) {
      ...
      if (this.mutating) {
        if (c && !e.prototype[c.type])
          throw new i["default"]('Unexpected node type "' + c.type + '" found when accepting ' + b + " on " + a.type);
        a[b] = c;
      }
    },
  ...
  e.prototype = new j["default"], e.prototype.Program = function(a) {
    ...
    if (a.openStrip.close && h(b.body, null, !0), c) {
      ...
      a.closeStrip.open && i(b.body, null, !0);
    return j;
  ...
  f.prototype = {
    ...
    equals: function(a) {
      ...
      for (var c = 0; c < b; c++) {
        var d = this.opcodes[c],
            e = a.opcodes[c];
        if (d.opcode !== e.opcode || !i(d.args, e.args))
          return !1;
      }
    ...
    blockParamIndex: function(a) {
      for (var b = 0,
          d = this.options.blockParams.length; b < d; b++) {
  ...
  try {
    if ("function" != typeof define || !define.amd) {
      var g = require('../../source-map/source-map');
      f = g.SourceNode;
    }
  } catch (h) {}
  ...
  i.prototype = {
    ...
    compile: function(a, b, c, d) {
      ...
      return this.environment.usePartial && (l.usePartial = !0), this.options.data && (l.useData = !0), this.useDepths && (l.useDepths = !0), this.useBlockParams && (l.useBlockParams = !0), this.options.compat && (l.compat = !0), d ? l.compilerOptions = this.options : (l.compiler = JSON.stringify(l.compiler), this.source.currentLocation = {start: {
          line: 1,
          column: 0
