...
var createCLIValidationError = function createCLIValidationError(unrecognizedOptions, allowedOptions) {
  ...
  var message = void 0;
  var comment = '  ' + chalk.bold('CLI Options Documentation') + ':\n' + '  http://facebook.github.io/jest/docs/cli.html\n';
  if (unrecognizedOptions.length === 1) {
    var unrecognized = unrecognizedOptions[0];
    var didYouMeanMessage = createDidYouMeanMessage(unrecognized, (0, _from2.default)(allowedOptions));
...
var validateCLIOptions = function validateCLIOptions(argv, options) {
  ...
  var allowedOptions = (0, _keys2.default)(options).reduce(function(acc, option) {
    return acc.add(option).add(options[option].alias || option);
  }, new _set2.default(yargsSpecialOptions));
  var unrecognizedOptions = (0, _keys2.default)(argv).filter(function(arg) {
