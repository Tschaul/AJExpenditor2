...
var CustomConsole = function(_Console) {
  (0, _inherits3.default)(CustomConsole, _Console);
  function CustomConsole(stdout, stderr, formatBuffer) {
    (0, _classCallCheck3.default)(this, CustomConsole);
    var _this = (0, _possibleConstructorReturn3.default)(this, (CustomConsole.__proto__ || (0, _getPrototypeOf2.default)(CustomConsole)).call(this, stdout, stderr));
    _this._formatBuffer = formatBuffer || function(type, message) {
      return message;
    };
    return _this;
  }
  (0, _createClass3.default)(CustomConsole, [{
    key: '_log',
