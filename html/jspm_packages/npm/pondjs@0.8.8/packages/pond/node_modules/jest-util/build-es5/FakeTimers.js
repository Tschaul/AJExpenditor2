...
var _require = require('../../jest-message-util/build/index'),
    formatStackTrace = _require.formatStackTrace;
var setGlobal = require('./setGlobal');
var MS_IN_A_YEAR = 31536000000;
var FakeTimers = function() {
  function FakeTimers(global, moduleMocker, config, maxLoops) {
    var _this = this;
    (0, _classCallCheck3.default)(this, FakeTimers);
    this._global = global;
    this._config = config;
    ...
    global.mockGetTimersCount = function() {
      return (0, _keys2.default)(_this._timers).length;
    };
  }
  (0, _createClass3.default)(FakeTimers, [{
    key: 'clearAllTimers',
    ...
    value: function runOnlyPendingTimers() {
      ...
      (0, _keys2.default)(timers).sort(function(left, right) {
        return timers[left].expiry - timers[right].expiry;
      }).forEach(this._runTimerHandle, this);
    }
  }, {
    key: 'runTimersToTime',
    value: function runTimersToTime(msToRun) {
      this._checkFakeTimers();
      var i = void 0;
      for (i = 0; i < this._maxLoops; i++) {
    ...
    key: '_fakeClearTimer',
    value: function _fakeClearTimer(uuid) {
