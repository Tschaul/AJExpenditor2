...
const HTMLHyperlinkElementUtils = require('./HTMLHyperlinkElementUtils');
...
const iface = {
  ...
  expose: {Window: {HTMLAnchorElement: HTMLAnchorElement}}
};
module.exports = iface;
const Impl = require('../nodes/HTMLAnchorElement-impl');
