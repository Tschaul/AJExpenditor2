/* */ 
"use strict";
const CookieJar = require('../../../../../tough-cookie/lib/cookie').CookieJar;
...
const nonInheritedTags = new Set(["article", "section", "nav", "aside", "hgroup", "header", "footer", "address", "dt", "dd", "figure", "figcaption", "main", "em", "strong", "small", "s", "cite", "dfn", "abbr", "ruby", "rt", "rp", "code", "var", "samp", "kbd", "i", "b", "u", "mark", "bdi", "bdo", "wbr"]);
...
class DocumentImpl extends NodeImpl {
  constructor(args, privateData) {
    ...
    this._activeNodeIteratorsMax = privateData.options.concurrentNodeIterators === undefined ? 10 : Number(privateData.options.concurrentNodeIterators);
  ...
  get links() {
    return createHTMLCollection(this, () => domSymbolTree.treeToArray(this, {filter(node) {
        return (node._localName === "a" || node._localName === "area") && node.hasAttribute("href") && node._namespaceURI === "http://www.w3.org/1999/xhtml";
      }}));
  }
  get forms() {
  ...
  get anchors() {
    return createHTMLCollection(this, () => domSymbolTree.treeToArray(this, {filter(node) {
        return node._localName === "a" && node.hasAttribute("name") && node._namespaceURI === "http://www.w3.org/1999/xhtml";
      }}));
  }
  get applets() {
  ...
  get body() {
    ...
    if (!documentElement || documentElement._localName !== "html" || documentElement._namespaceURI !== "http://www.w3.org/1999/xhtml") {
      return null;
    }
  ...
  set body(value) {
    ...
    if (value._namespaceURI !== "http://www.w3.org/1999/xhtml" || (value._localName !== "body" && value._localName !== "frameset")) {
...
module.exports = {implementation: DocumentImpl};
