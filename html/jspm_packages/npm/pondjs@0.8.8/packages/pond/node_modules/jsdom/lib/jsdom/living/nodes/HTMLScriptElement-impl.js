...
(function(process) {
  ...
  class HTMLScriptElementImpl extends HTMLElementImpl {
    ...
    _eval(text, filename) {
      ...
      if (this._ownerDocument.implementation._hasFeature("ProcessExternalResources", "script") && jsMIMETypes.has(typeString.toLowerCase())) {
  ...
  module.exports = {implementation: HTMLScriptElementImpl};
})(require('process'));
