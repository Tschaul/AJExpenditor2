...
const NavigatorCookies = require('./NavigatorCookies');
const NavigatorPlugins = require('./NavigatorPlugins');
...
const iface = {
  ...
  interface: Navigator,
  expose: {Window: {Navigator: Navigator}}
};
module.exports = iface;
const Impl = require('../navigator/Navigator-impl');
