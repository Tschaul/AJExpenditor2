...
(function(Buffer, process) {
  ...
  const URL = require('../../../../whatwg-url/lib/public-api').URL;
  const whatwgEncoding = require('../../../../whatwg-encoding/lib/whatwg-encoding');
  const tough = require('../../../../tough-cookie/lib/cookie');
    ...
    class XMLHttpRequest extends XMLHttpRequestEventTarget {
          ...
          case "blob":
            {
              ...
              res = Blob.create([[new Uint8Array(properties.responseBuffer)], {type: contentType && contentType.toString() || ""}]);
              break;
            }
          case "document":
            {
      ...
      send(body) {
        ...
        if (flag.synchronous) {
          ...
          const res = spawnSync(process.execPath, [syncWorkerFile], {input: flagStr});
          if (res.status !== 0) {
