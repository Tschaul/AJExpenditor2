/* */ 
"use strict";
const parse5 = require('../../../../parse5/index');
...
function setChild(core, parentImpl, node) {
  ...
  if (node.attribs) {
    Object.keys(node.attribs).forEach((localName) => {
      ...
      let prefix = node["x-attribsPrefix"] && Object.prototype.hasOwnProperty.call(node["x-attribsPrefix"], localName) && node["x-attribsPrefix"][localName] || null;
      const namespace = node["x-attribsNamespace"] && Object.prototype.hasOwnProperty.call(node["x-attribsNamespace"], localName) && node["x-attribsNamespace"][localName] || null;
