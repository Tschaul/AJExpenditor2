...
const WindowEventHandlers = require('./WindowEventHandlers');
...
const iface = {
  ...
  expose: {Window: {HTMLFrameSetElement: HTMLFrameSetElement}}
};
module.exports = iface;
const Impl = require('../nodes/HTMLFrameSetElement-impl');
