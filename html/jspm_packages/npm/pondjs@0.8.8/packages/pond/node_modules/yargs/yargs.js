...
(function(process) {
  ...
  const Parser = require('../yargs-parser/index');
  const path = require('path');
  const Usage = require('./lib/usage');
  const Validation = require('./lib/validation');
  const Y18n = require('../y18n/index');
  const objFilter = require('./lib/obj-filter');
  const setBlocking = require('../set-blocking/index');
  ...
  function Yargs(processArgs, cwd, parentRequire) {
    ...
    self.commandDir = function(dir, opts) {
      ...
      command.addDirectory(dir, self.getContext(), req, require('../get-caller-file/index')(), opts);
      return self;
    };
    ...
    function pkgUp(path) {
      ...
      try {
        obj = readPkgUp.sync({
          cwd: path || require('../require-main-filename/index')(parentRequire || require),
          normalize: false
        });
      } catch (noop) {}
      pkgs[npath] = obj.pkg || {};
    ...
    function guessLocale() {
      if (!detectLocale)
        return;
      try {
        const osLocale = require('../os-locale/index');
