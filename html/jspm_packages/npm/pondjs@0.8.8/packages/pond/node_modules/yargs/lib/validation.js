...
module.exports = function(yargs, usage, y18n) {
  ...
  self.unknownArguments = function(argv, aliases, positionalMap) {
    ...
    Object.keys(argv).forEach(function(key) {
      if (key !== '$0' && key !== '_' && !descriptions.hasOwnProperty(key) && !demandedOptions.hasOwnProperty(key) && !positionalMap.hasOwnProperty(key) && !yargs._getParseContext().hasOwnProperty(key) && !aliasLookup.hasOwnProperty(key)) {
        unknown.push(key);
      }
    });
