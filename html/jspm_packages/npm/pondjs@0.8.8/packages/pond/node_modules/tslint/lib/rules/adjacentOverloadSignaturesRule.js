...
function walk(ctx) {
  ...
  function addFailures(misplacedOverloads) {
    for (var _i = 0,
        misplacedOverloads_1 = misplacedOverloads; _i < misplacedOverloads_1.length; _i++) {
...
function getMisplacedOverloads(overloads, getKey) {
  ...
  var seen = new Set();
  for (var _i = 0,
      overloads_1 = overloads; _i < overloads_1.length; _i++) {
...
function getOverloadKey(node) {
  ...
  var _a = typeof info === "string" ? [false, info] : [info.computed, info.name],
      computed = _a[0],
      name = _a[1];
    ...
    default:
      {
        ...
        switch (name.kind) {
          ...
          case ts.SyntaxKind.ComputedPropertyName:
            ...
            return utils.isLiteralExpression(expression) ? expression.text : {
