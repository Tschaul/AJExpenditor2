...
var parseConfigOptions = function(configOptions) {
  ...
  return {
    ...
    allowDestructuring: allowDestructuring
  };
};
var Rule = (function(_super) {
  ...
  Rule.metadata = {
    ...
    optionExamples: [true, [true, (_a = {}, _a[ALLOWED_THIS_NAMES] = ["^self$"], _a[ALLOW_THIS_DESTRUCTURING] = true, _a)]],
    options: {
      additionalProperties: false,
      properties: (_b = {}, _b[ALLOW_THIS_DESTRUCTURING] = {type: "boolean"}, _b[ALLOWED_THIS_NAMES] = {
        listType: "string",
        type: "list"
      }, _b),
      type: "object"
...
var NoThisAssignmentWalker = (function(_super) {
  ...
  function NoThisAssignmentWalker() {
    ...
    _this.allowedThisNameTesters = _this.options.allowedNames.map(function(allowedThisName) {
      return new RegExp(allowedThisName);
    });
  ...
  NoThisAssignmentWalker.prototype.variableNameIsBanned = function(name) {
    for (var _i = 0,
        _a = this.allowedThisNameTesters; _i < _a.length; _i++) {
      var tester = _a[_i];
      if (tester.test(name)) {
        return false;
      }
