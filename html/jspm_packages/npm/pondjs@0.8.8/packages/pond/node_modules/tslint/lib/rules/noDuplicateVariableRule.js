...
var Rule = (function(_super) {
  ...
  Rule.prototype.apply = function(sourceFile) {
    return this.applyWithWalker(new NoDuplicateVariableWalker(sourceFile, this.ruleName, {parameters: this.ruleArguments.indexOf(OPTION_CHECK_PARAMETERS) !== -1}));
  };
  Rule.metadata = {
...
var NoDuplicateVariableWalker = (function(_super) {
  ...
  NoDuplicateVariableWalker.prototype.handleBindingName = function(name, check) {
    if (name.kind === ts.SyntaxKind.Identifier) {
      ...
      for (var _i = 0,
          _a = name.elements; _i < _a.length; _i++) {
        var e = _a[_i];
