...
var Formatter = (function(_super) {
  ...
  Formatter.prototype.mapToMessages = function(failures) {
    ...
    for (var _i = 0,
      ...
      positionTuple = failure.getRuleSeverity() === "warning" ? colors.blue(failure.getRuleSeverity().toUpperCase() + ": " + positionTuple) : colors.red(failure.getRuleSeverity().toUpperCase() + ": " + positionTuple);
  ...
  Formatter.prototype.getPositionMaxSize = function(failures) {
    ...
    for (var _i = 0,
        failures_2 = failures; _i < failures_2.length; _i++) {
  ...
  Formatter.prototype.getRuleMaxSize = function(failures) {
    var ruleMaxSize = 0;
    for (var _i = 0,
        failures_3 = failures; _i < failures_3.length; _i++) {
