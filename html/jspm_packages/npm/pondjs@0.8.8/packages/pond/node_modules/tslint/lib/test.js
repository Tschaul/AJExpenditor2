...
(function(process) {
  ...
  function runTests(patterns, rulesDirectory) {
    var files = [];
    for (var _i = 0,
        patterns_1 = patterns; _i < patterns_1.length; _i++) {
    ...
    return files.map(function(directory) {
      return runTest(path.dirname(directory), rulesDirectory);
    });
  }
  ...
  function runTest(testDirectory, rulesDirectory) {
    ...
    if (hasConfig) {
      var _a = ts.readConfigFile(tsConfig, ts.sys.readFile),
          config = _a.config,
          error = _a.error;
      if (error !== undefined) {
    ...
    var _loop_1 = function(fileToLint) {
      ...
      if (hasConfig) {
        var compilerHost = {
          fileExists: function(file) {
            return file === fileCompileName || fs.existsSync(file);
          },
      ...
      try {
        ...
        if (stat.isFile()) {
          ...
          var fixes = utils_1.mapDefined(failures, function(f) {
            return f.getFix();
          });
  ...
  function consoleTestResultsHandler(testResults) {
    ...
    for (var _i = 0,
        testResults_1 = testResults; _i < testResults_1.length; _i++) {
  ...
  function consoleTestResultHandler(testResult) {
    ...
    for (var _i = 0,
      ...
      if (results.skipped) {
        ...
        var didMarkupTestPass = !markupDiffResults.some(function(hunk) {
          return hunk.added === true || hunk.removed === true;
        });
        var didFixesTestPass = !fixesDiffResults.some(function(hunk) {
          return hunk.added === true || hunk.removed === true;
        });
  ...
  function displayDiffResults(diffResults, extension) {
    ...
    for (var _i = 0,
        diffResults_1 = diffResults; _i < diffResults_1.length; _i++) {
