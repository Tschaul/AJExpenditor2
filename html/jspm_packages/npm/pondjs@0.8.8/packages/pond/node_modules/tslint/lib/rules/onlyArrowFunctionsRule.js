...
function walk(ctx) {
  var sourceFile = ctx.sourceFile,
      _a = ctx.options,
      allowDeclarations = _a.allowDeclarations,
      allowNamedFunctions = _a.allowNamedFunctions;
...
function hasThisParameter(node) {
  ...
  return first !== undefined && first.name.kind === ts.SyntaxKind.Identifier && first.name.originalKeywordKind === ts.SyntaxKind.ThisKeyword;
}
