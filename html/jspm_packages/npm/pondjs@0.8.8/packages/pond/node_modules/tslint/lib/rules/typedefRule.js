...
var Rule = (function(_super) {
  ...
  Rule.metadata = {
    ...
    options: {
      ...
      items: {
        type: "string",
        enum: [OPTION_CALL_SIGNATURE, OPTION_ARROW_CALL_SIGNATURE, OPTION_PARAMETER, OPTION_ARROW_PARAMETER, OPTION_PROPERTY_DECLARATION, OPTION_VARIABLE_DECLARATION, OPTION_MEMBER_VARIABLE_DECLARATION, OPTION_OBJECT_DESTRUCTURING, OPTION_ARRAY_DESTRUCTURING]
      },
      minLength: 0,
      maxLength: 7
    },
...
var TypedefWalker = (function(_super) {
  ...
  TypedefWalker.prototype.checkPropertyDeclaration = function(_a) {
    var initializer = _a.initializer,
        name = _a.name,
        type = _a.type;
  ...
  TypedefWalker.prototype.checkVariableDeclaration = function(_a) {
    var parent = _a.parent,
        name = _a.name,
        type = _a.type;
    if (parent.kind === ts.SyntaxKind.CatchClause || parent.parent.kind === ts.SyntaxKind.ForInStatement || parent.parent.kind === ts.SyntaxKind.ForOfStatement) {
      return;
    }
    var option = (function() {
      switch (name.kind) {
