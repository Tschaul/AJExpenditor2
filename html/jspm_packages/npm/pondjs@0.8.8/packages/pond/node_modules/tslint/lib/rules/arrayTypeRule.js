...
function walk(ctx) {
  ...
  function checkArrayType(node) {
    ...
    var fix = [new Lint.Replacement(elementType.getStart(), parens, (space ? " " : "") + "Array<"), Lint.Replacement.replaceFromTo(elementType.getEnd() - parens, node.getEnd(), ">")];
  ...
  function checkTypeReference(node) {
    ...
    ctx.addFailureAtNode(node, failureString, [Lint.Replacement.replaceFromTo(node.getStart(), type.getStart(), parens ? "(" : ""), Lint.Replacement.replaceFromTo(type.getEnd(), node.getEnd(), parens ? ")[]" : "[]")]);
  }
}
  ...
  switch (nodeType.kind) {
    ...
    case ts.SyntaxKind.TypeReference:
      var _a = nodeType,
          ...
          typeArguments = _a.typeArguments;
