...
var Rule = (function(_super) {
  ...
  Rule.prototype.apply = function(sourceFile) {
    ...
    return this.applyWithWalker(new CurlyWalker(sourceFile, this.ruleName, {ignoreSameLine: this.ruleArguments.indexOf(OPTION_IGNORE_SAME_LINE) !== -1}));
  };
  Rule.metadata = {
    ruleName: "curly",
...
function isBlockUnnecessary(node) {
  ...
  return tsutils_1.isIfStatement(parent) && !(tsutils_1.isIfStatement(statement) && statement.elseStatement === undefined && parent.thenStatement === node && parent.elseStatement !== undefined);
}
var CurlyWalker = (function(_super) {
  ...
  CurlyWalker.prototype.checkStatement = function(statement, node, childIndex, end) {
    ...
    if (statement.kind !== ts.SyntaxKind.Block && !(this.options.ignoreSameLine && tsutils_1.isSameLine(this.sourceFile, statement.pos, statement.end))) {
