...
var Rule = (function(_super) {
  ...
  Rule.prototype.apply = function(sourceFile) {
    return this.applyWithWalker(new ObjectLiteralKeyQuotesWalker(sourceFile, this.ruleName, {option: this.ruleArguments.length === 0 ? "always" : this.ruleArguments[0]}));
  };
  Rule.metadata = {
    ...
    var cb = function(node) {
      if (tsutils_1.isObjectLiteralExpression(node)) {
        ...
        outer: switch (_this.options.option) {
          case "always":
            for (var _i = 0,
                propertyNames_1 = propertyNames; _i < propertyNames_1.length; _i++) {
          ...
          case "as-needed":
            for (var _a = 0,
                propertyNames_2 = propertyNames; _a < propertyNames_2.length; _a++) {
          ...
          case "consistent-as-needed":
            for (var _b = 0,
                propertyNames_3 = propertyNames; _b < propertyNames_3.length; _b++) {
              var name = propertyNames_3[_b];
              if (name.kind === ts.SyntaxKind.StringLiteral && !tsutils_1.isValidPropertyName(name.text)) {
                for (var _c = 0,
                    propertyNames_4 = propertyNames; _c < propertyNames_4.length; _c++) {
            ...
            for (var _d = 0,
                propertyNames_5 = propertyNames; _d < propertyNames_5.length; _d++) {
...
function mapPropertyName(property) {
  if (property.kind === ts.SyntaxKind.ShorthandPropertyAssignment || property.kind === ts.SyntaxKind.SpreadAssignment || property.name.kind === ts.SyntaxKind.ComputedPropertyName) {
    return undefined;
  }
