...
var NoInternalModuleWalker = (function(_super) {
  ...
  NoInternalModuleWalker.prototype.checkModuleDeclaration = function(node, nested) {
    if (!nested && node.name.kind === ts.SyntaxKind.Identifier && !Lint.isNodeFlagSet(node, ts.NodeFlags.Namespace) && !Lint.isNodeFlagSet(node, ts.NodeFlags.GlobalAugmentation)) {
