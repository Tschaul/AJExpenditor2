...
function parseOptions(args) {
  ...
  var methods = [];
  for (var _i = 0,
      args_1 = args; _i < args_1.length; _i++) {
    var arg = args_1[_i];
...
var BanFunctionWalker = (function(_super) {
  ...
  BanFunctionWalker.prototype.checkForObjectMethodBan = function(expression) {
    for (var _i = 0,
        _a = this.options.methods; _i < _a.length; _i++) {
      var ban = _a[_i];
      ...
      if (ban.object[0] === "*" || tsutils_1.isIdentifier(current) && current.text === ban.object[0]) {
  ...
  BanFunctionWalker.prototype.checkFunctionBan = function(name) {
    var text = name.text;
    for (var _i = 0,
        _a = this.options.functions; _i < _a.length; _i++) {
      var ban = _a[_i];
      if (ban.name === text) {
