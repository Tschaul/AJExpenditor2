...
const utils = require('../../jest-matcher-utils/build/index');
...
if (!global[GLOBAL_STATE]) {
  Object.defineProperty(global, GLOBAL_STATE, {value: {
...
const makeResolveMatcher = (matcherName, matcher, isNot, actual) => _asyncToGenerator(function*() {
...
const makeRejectMatcher = (matcherName, matcher, isNot, actual) => _asyncToGenerator(function*() {
...
const makeThrowingMatcher = (matcher, isNot, actual) => {
  return function throwingMatcher() {
    let throws = true;
    const matcherContext = Object.assign({dontThrow: () => throws = false}, global[GLOBAL_STATE].state, {
      equals,
      isNot,
      utils
    });
