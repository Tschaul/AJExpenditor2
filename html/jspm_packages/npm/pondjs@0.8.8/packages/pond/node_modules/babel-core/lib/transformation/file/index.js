...
(function(process) {
  ...
  var _babelHelpers = require('../../../../babel-helpers/lib/index');
  var _babelHelpers2 = _interopRequireDefault(_babelHelpers);
  var _metadata = require('./metadata');
  var metadataVisitor = _interopRequireWildcard(_metadata);
  var _convertSourceMap = require('../../../../convert-source-map/index');
  ...
  var _sourceMap = require('../../../../source-map/source-map');
  var _sourceMap2 = _interopRequireDefault(_sourceMap);
  var _babelGenerator = require('../../../../babel-generator/lib/index');
  var _babelGenerator2 = _interopRequireDefault(_babelGenerator);
  var _babelCodeFrame = require('../../../../babel-code-frame/lib/index');
    ...
    File.prototype.parse = function parse(code) {
      ...
      if (parserOpts) {
        ...
        if (parserOpts.parser) {
          ...
          parserOpts.parser = {parse: function parse(source) {
