...
(function(Buffer, process) {
  ...
  var http = require('http'),
      ...
      zlib = require('zlib'),
      hawk = require('../hawk/lib/index'),
      aws2 = require('../aws-sign2/index'),
      aws4 = require('../aws4/aws4'),
      httpSignature = require('../http-signature/lib/index'),
      mime = require('../mime-types/index'),
      stringstream = require('../stringstream/stringstream'),
      caseless = require('../caseless/index'),
      ForeverAgent = require('../forever-agent/index'),
      FormData = require('../form-data/lib/form_data'),
      extend = require('../extend/index'),
      isstream = require('../isstream/isstream'),
      isTypedArray = require('../is-typedarray/index').strict,
      ...
      now = require('../performance-now/lib/performance-now'),
      Buffer = require('../safe-buffer/index').Buffer;
