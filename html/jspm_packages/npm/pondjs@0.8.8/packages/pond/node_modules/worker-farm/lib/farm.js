...
(function(process) {
  ...
  const extend = require('../../xtend/immutable'),
      fork = require('./fork'),
      TimeoutError = require('../../errno/errno').create('TimeoutError'),
      ProcessTerminatedError = require('../../errno/errno').create('ProcessTerminatedError'),
      MaxConcurrentCallsError = require('../../errno/errno').create('MaxConcurrentCallsError');
