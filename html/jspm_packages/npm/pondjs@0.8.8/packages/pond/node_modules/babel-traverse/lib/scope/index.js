...
var _babelMessages = require('../../../babel-messages/lib/index');
var messages = _interopRequireWildcard(_babelMessages);
var _binding2 = require('./binding');
var _binding3 = _interopRequireDefault(_binding2);
var _globals = require('../../../globals/index');
...
var collectorVisitor = {
  For: function For(path) {
    for (var _iterator4 = t.FOR_INIT_KEYS,
  ...
  ExportDeclaration: {exit: function exit(path) {
      var node = path.node,
          scope = path.scope;
      ...
      if (t.isClassDeclaration(declar) || t.isFunctionDeclaration(declar)) {
        ...
        for (var _iterator5 = declar.declarations,
