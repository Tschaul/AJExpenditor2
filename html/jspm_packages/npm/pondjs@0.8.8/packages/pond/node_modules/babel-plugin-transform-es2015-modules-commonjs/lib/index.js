...
exports.default = function() {
  ...
  return {
    inherits: require('../../babel-plugin-transform-strict-mode/lib/index'),
    visitor: {
      ...
      Program: {exit: function exit(path) {
            ...
            if (_path.isImportDeclaration()) {
              ...
              if (_declaration.node) {
                if (_declaration.isFunctionDeclaration()) {
                  ...
                  for (var _iterator5 = declarators,
              ...
              if (_source) {
                ...
                for (var _iterator7 = _specifiers,
              ...
              var exportNode = buildExportAll({OBJECT: addRequire(_path.node.source.value, _path.node._blockHoist)});
...
var _babelTemplate = require('../../babel-template/lib/index');
