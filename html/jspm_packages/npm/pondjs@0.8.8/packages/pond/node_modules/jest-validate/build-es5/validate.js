...
var validate = function validate(config, options) {
  ...
  var defaultedOptions = (0, _assign2.default)({}, defaultConfig, options, {title: (0, _assign2.default)({}, defaultConfig.title, options.title)});
  var _validate2 = _validate(config, defaultedOptions),
      hasDeprecationWarnings = _validate2.hasDeprecationWarnings;
  return {
