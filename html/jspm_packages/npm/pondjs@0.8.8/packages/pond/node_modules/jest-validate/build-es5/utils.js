...
var format = function format(value) {
  return (typeof value === 'function' ? value.toString() : require('../../pretty-format/build/index')(value, {min: true}));
};
var ValidationError = function(_Error) {
  ...
  function ValidationError(name, message, comment) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (ValidationError.__proto__ || (0, _getPrototypeOf2.default)(ValidationError)).call(this));
    comment = comment ? '\n\n' + comment : '\n';
    _this.name = '';
    _this.stack = '';
