/* */ 
(function(process) {
  var mod_assert = require('../../assert-plus/assert');
  var mod_util = require('util');
  var mod_extsprintf = require('../../extsprintf/lib/extsprintf');
  var mod_verror = require('../../verror/lib/verror');
  var mod_jsonschema = require('../../json-schema/lib/validate');
