    ...
    return (function e(t, n, r) {
          ...
          switch (typeof transpile) {
            ...
            case 'boolean':
              if (typeof async == 'string') {
                check = ASYNC[async];
                if (!check)
                  throw new Error('bad async mode: ' + async);
      ...
      6: [function(require, module, exports) {
        ...
        var resolve = require('./resolve'),
            util = require('./util'),
            stableStringify = require('../../json-stable-stringify/index'),
            async = require('../async');
        var beautify;
      ...
      39: [function(require, module, exports) {
        module.exports = {
          ...
          "properties": {
            ...
            "formatExclusiveMaximum": {"anyOf": [{
                "type": "boolean",
                "default": false
              }, {"$ref": "#/definitions/$data"}]},
            "formatExclusiveMinimum": {"anyOf": [{
                "type": "boolean",
                "default": false
              }, {"$ref": "#/definitions/$data"}]},
      ...
      40: [function(require, module, exports) {
        ...
        function enableV5(ajv) {
          ...
          if (ajv._opts.meta !== false) {
            var metaSchema = require('./refs/json-schema-v5.json!systemjs-json');
      ...
      42: [function(require, module, exports) {
        var json = typeof JSON !== 'undefined' ? JSON : require('../../jsonify/index');
