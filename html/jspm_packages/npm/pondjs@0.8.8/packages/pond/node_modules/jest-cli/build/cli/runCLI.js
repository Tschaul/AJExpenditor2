...
(function(process) {
  ...
  var _require2 = require('../../../jest-util/build/index');
  const createDirectory = _require2.createDirectory;
  var _require3 = require('../../../jest-config/build/index');
      ...
      const _run = (() => {
        var _ref2 = _asyncToGenerator(function*(globalConfig, configs) {
          ...
          if (argv.watch || argv.watchAll) {
            if (configs.some(function(_ref5) {
            ...
            const startRun = function() {
              ...
              runJest(globalConfig, contexts, argv, pipe, new TestWatcher({isWatchMode: false}), startRun, onComplete);
            };
            return startRun();
          }
        });
