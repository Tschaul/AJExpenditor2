...
'use strict';
const fs = require('fs');
const getCacheFilePath = require('../../jest-haste-map/build/index').getCacheFilePath;
const FAIL = 0;
const SUCCESS = 1;
class TestSequencer {
  constructor() {
  ...
  sort(tests) {
    const stats = {};
    const fileSize = (test) => stats[test.path] || (stats[test.path] = fs.statSync(test.path).size);
