...
(function(process) {
  ...
  var _require2 = require('../../../istanbul-api/index');
  const createReporter = _require2.createReporter;
  const chalk = require('../../../chalk/index');
  const isCI = require('../../../is-ci/index');
  const istanbulCoverage = require('../../../istanbul-lib-coverage/index');
  const libSourceMaps = require('../../../istanbul-lib-source-maps/index');
  ...
  class CoverageReporter extends BaseReporter {
    ...
    onRunComplete(contexts, aggregatedResults) {
      ...
      return _asyncToGenerator(function*() {
        ...
        if (_this._globalConfig.mapCoverage) {
          var _sourceMapStore$trans = _this._sourceMapStore.transformCoverage(map);
    ...
    _checkThreshold(globalConfig, map) {
      if (globalConfig.coverageThreshold) {
        ...
        const errors = check('global', globalConfig.coverageThreshold.global, results);
        if (errors.length > 0) {
