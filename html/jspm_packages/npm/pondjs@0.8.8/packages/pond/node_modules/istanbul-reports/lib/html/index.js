...
var fs = require('fs'),
    path = require('path'),
    handlebars = require('../../../handlebars/lib/index').create(),
    ...
    detailTemplate = handlebars.compile(['<tr>', '<td class="line-count quiet">{{#show_lines}}{{maxLines}}{{/show_lines}}</td>', '<td class="line-coverage quiet">{{#show_line_execution_counts lineCoverage}}{{maxLines}}{{/show_line_execution_counts}}</td>', '<td class="text"><pre class="prettyprint lang-js">{{#show_code annotatedCode}}{{/show_code}}</pre></td>', '</tr>\n'].join('')),
...
function fillTemplate(node, templateData, linkMapper, context) {
  ...
  templateData.base = {css: linkMapper.assetPath(node, 'base.css')};
  templateData.sorter = {
