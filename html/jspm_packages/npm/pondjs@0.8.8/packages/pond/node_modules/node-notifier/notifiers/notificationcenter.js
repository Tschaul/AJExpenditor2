...
NotificationCenter.prototype.notify = function(options, callback) {
  ...
  var actionJackedCallback = utils.actionJackerDecorator(this, options, function() {
  ...
  if (utils.isMountainLion()) {
    var cp = utils.fileCommandJson(this.options.customPath || notifier, argsList, actionJackedCallback);
