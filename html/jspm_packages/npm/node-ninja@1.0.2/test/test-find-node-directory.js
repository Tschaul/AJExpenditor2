...
(function(process) {
  ...
  test('test find-node-directory - node install', function(t) {
    ...
    for (var next = 0; next < platforms.length; next++) {
      ...
      t.equal(findNodeDirectory('/x/deps/npm/node_modules/node-ninja/lib', processObj), path.join('/x'));
    }
  });
  test('test find-node-directory - node build', function(t) {
    ...
    for (var next = 0; next < platforms.length; next++) {
      ...
      if (platforms[next] === 'win32') {
        t.equal(findNodeDirectory('/y/node_modules/npm/node_modules/node-ninja/lib', processObj), path.join('/y'));
      } else {
        t.equal(findNodeDirectory('/y/lib/node_modules/npm/node_modules/node-ninja/lib', processObj), path.join('/y'));
      }
    }
  });
  test('test find-node-directory - node in bin directory', function(t) {
    ...
    for (var next = 0; next < platforms.length; next++) {
      ...
      t.equal(findNodeDirectory('/nothere/npm/node_modules/node-ninja/lib', processObj), path.join('/x/y'));
    }
  });
  ...
  test('test find-node-directory - node in Debug release dir', function(t) {
    ...
    for (var next = 0; next < platforms.length; next++) {
      ...
      t.equal(findNodeDirectory('/nothere/npm/node_modules/node-ninja/lib', processObj), path.join('/a/b'));
    }
  });
  ...
  test('test find-node-directory - node install', function(t) {
    ...
    for (var next = 0; next < platforms.length; next++) {
      ...
      t.equal(findNodeDirectory('/x/y/z/a/b/c/deps/npm/node_modules/node-ninja/lib', processObj), path.join('/x/y/z/a/b/c'));
    }
  });
})(require('process'));
