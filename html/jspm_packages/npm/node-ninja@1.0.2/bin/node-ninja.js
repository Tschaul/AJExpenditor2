...
(function(process) {
  ...
  function issueMessage() {
    errorMessage();
    log.error('', ['This is a bug in `node-ninja`.', 'Try to update node-ninja and file an Issue if it does not help:', '    <https://github.com/codejockey/node-ninja/issues>'].join('\n'));
  }
  run();
})(require('process'));
