...
(function(process) {
  ...
  function findNodeDirectory(scriptLocation, processObj) {
    ...
    log.verbose('node-ninja root', 'npm_parent_directory is ' + path.basename(npm_parent_directory));
    node_root_dir = "";
    ...
    if (path.basename(npm_parent_directory) === 'deps') {
      ...
      log.verbose('node-ninja root', 'in build directory, root = ' + node_root_dir);
      ...
      log.verbose('node-ninja root', 'in install directory, root = ' + node_root_dir);
    } else {
